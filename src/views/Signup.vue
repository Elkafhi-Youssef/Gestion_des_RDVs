          ...
          <div class="row justify-content-center">
            <div class="col-md-8">
              ...
              <form class="infos" v-on:submit.prevent="Signup">
                ...
                <button type="submit" class="btn btn-primary btnvalider text-black">
                  Signup
                </button>
  ...
  methods: {
    async Signup() {
      ...
      const response = await fetch(
        "http://localhost/gestionRDVS/back-end/api/User/addUser",
        {
          method: "POST", 
          headers: {
     ...
     swal({
       title: "This is your ID. Please don't lose it  "+data.reference,
      icon: "success",
      button: "ok",
